    ...
    <div id="carousel" class="carousel carousel-fade" data-ride="carousel">
      <div class="carousel-inner" role="listbox">
        <div class="carousel-item active" >
            <div class="main-slider slider" style="background:url(<?=yii::$app->homeUrl?>images/Banner/slide-1.jpg) no-repeat;">
            <div class="overlay">
              <div class="slide-margin">
                <div class="container">
                  <div class="carousel-content">
                    <h1 class="animation animated-item-1 head-style">Defibrilator </h1>
                    <h3 class="animation animated-item-2 head-style3">Defibrillation is a process in which an electronic device gives an electric shock to the heart. <br>This helps reestablish normal contraction rhythms in a heart having dangerous arrhythmia or in cardiac arrest.</h3>
                    <a class="button-link animation animated-item-3" href="#" style="z-index:1;">View now!</a> </div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="carousel-item" style="position:absolute;  top:0px; ">
          <div class="main-slider slider" style="background:url(<?=yii::$app->homeUrl?>images/Banner/slide-2.jpg) no-repeat;">
            <div class="overlay">
              <div class="slide-margin">
                <div class="container">
                  <div class="carousel-content">
                    <h1 class="animation animated-item-1 head-style">Bed Head Unit</h1>
                    <h3 class="animation animated-item-2 head-style3">Bedhead unit is a horizontal type integrating a variety of functions such as those for doctors and nurses to <br>
                      make diagnosis and medical treatment and those for patient's lighting and communication</h3>
                    <a class="button-link  animation animated-item-3" href="#" style="z-index:1;">View now!</a> </div>
                </div>
              </div>
            </div>
  ...
  <section class="home-brand-section">
    <div class="container">
      ...
      <div class="slider lazy">
        <div class="clients-box"> <img src="images/Partners/b1.png" alt="" title="" class="img-fluid"> </div>
        <div class="clients-box"> <img src="images/Partners/b2.png" alt="" title="" class="img-fluid"> </div>
        <div class="clients-box"> <img src="images/Partners/b3.png" alt="" title="" class="img-fluid"> </div>
        <div class="clients-box"> <img src="images/Partners/b4.png" alt="" title="" class="img-fluid"> </div>
        <div class="clients-box"> <img src="images/Partners/b5.png" alt="" title="" class="img-fluid"> </div>
        <div class="clients-box"> <img src="images/Partners/b6.png" alt="" title="" class="img-fluid"> </div>
        <div class="clients-box"> <img src="images/Partners/b7.png" alt="" title="" class="img-fluid"> </div>
        <div class="clients-box"> <img src="images/Partners/b8.png" alt="" title="" class="img-fluid"> </div>
        <div class="clients-box"> <img src="images/Partners/b9.png" alt="" title="" class="img-fluid"> </div>
        <div class="clients-box"> <img src="images/Partners/b10.png" alt="" title="" class="img-fluid"> </div>
        <div class="clients-box"> <img src="images/Partners/b11.png" alt="" title="" class="img-fluid"> </div>
        <div class="clients-box"> <img src="images/Partners/b12.png" alt="" title="" class="img-fluid"> </div>
        <div class="clients-box"> <img src="images/Partners/b13.png" alt="" title="" class="img-fluid"> </div>
        <div class="clients-box"> <img src="images/Partners/b14.png" alt="" title="" class="img-fluid"> </div>
        <div class="clients-box"> <img src="images/Partners/b15.png" alt="" title="" class="img-fluid"> </div>
        <div class="clients-box"> <img src="images/Partners/b16.png" alt="" title="" class="img-fluid"> </div>
      </div>
    </div>
    </div>
  </section>
      ...
      <div class="slider lazy-testimonials">
          ...
          <div class="quote-icon"></div>
            <div class="quote-default-text">
              <p>I love to use your ready-made and beautifully looking templates. They are available at very affordable prices and they save me a lot of time, and deliver from a lot of sweat and tears!</p>
            </div>
            <h2 class="quote-default-cite">Jane Smith</h2>
          </div>
          <div class="quote-default"> 
          <div class="quote-icon"></div>
            <div class="quote-default-text">
